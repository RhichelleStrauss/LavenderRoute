    ...
    <div className="home-fullscreen-container">
      ...
      <main className="home-main-content">
          ...
          <div className="left-column">
            <section className="misty-glass-panel">
              ...
              <p className="body-text">
                A shadowy hub for serious Pokémon traders, where rare finds and
                elite builds change hands fast. Built on privacy, trust, and
                reputation, our platform connects collectors who value
                discretion as much as the thrill of the trade.
              </p>
            </section>
        ...
        <section className="misty-glass-panel bottom-panel">
          ...
          <p className="body-text">
            Create an account, verify your profile, and set up your payout
            method. Sellers list their Pokémon with clear details, set a price
            or auction, and agree to platform rules. Once approved, listings go
            live in the marketplace.
          </p>
          <br />
          <p className="body-text">
            When a buyer purchases, the platform holds payment in escrow. The
            seller completes the in-game trade within the agreed window and
            provides proof of delivery. After the buyer confirms, funds are
            released.
          </p>
        </section>
      </main>
