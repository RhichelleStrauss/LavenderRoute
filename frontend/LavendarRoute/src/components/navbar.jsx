...
const Navbar = () => {
  ...
  return (
    <nav className="misty-glass-nav">
      ...
      <div className="nav-actions">
        <svg onClick={() => navigate('/cart')} className="action-icon text-lime" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
