    ...
    <nav className="misty-glass-nav">
      ...
      >
        ...
        <h1 className="nav-brand">
          <span className="text-purple">LAVENDER</span>{" "}
          <span className="text-lime">ROUTE</span>
        </h1>
      </div>
      ...
      <div className={`nav-content ${isMenuOpen ? "open" : ""}`}>
        <div className="nav-links" style={{ color: "#FFFFFF" }}>
          <NavLink to="/" className="nav-link-btn" onClick={closeMenu}>
            HOME
          </NavLink>
          <NavLink to="/catalog" className="nav-link-btn" onClick={closeMenu}>
            INVENTORY
          </NavLink>
        </div>
            ...
            {showLogout && isLoggedIn ? (
              ...
              <img
                ...
                title={
                  isLoggedIn
                    ? "Trainer Profile"
                    : "Trainer Login / Encrypted Access"
                }
                className="action-icon action-icon-png"
              />
            )}
